...
<body>
    <div class="flex">
        <div class="w-1/2 bg-gradient-to-r from-blue to-green h-screen px-16">
            ...
            <div class="block p-6 rounded-lg shadow-lg bg-black w-full bg-opacity-70">
                <form>
                    <div class="form-group mb-6 ">
                        ...
                        id="email" aria-describedby="emailHelp" placeholder="Masukan Email">
                    </div>
                    <div class="form-group mb-6">
                    ...
                    <p class="text-white mt-6 text-center">
                        Sudah Punya Akun..?
                        <a href={{route('login.index')}} class="text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out font-bold">
                            Masuk
                        </a>
                    </p>
                </form>
        ...
        <div class="w-1/2 h-screen bg-cover bg-center" style="background-image: url({{asset('images/foto-2.jpg')}})">
